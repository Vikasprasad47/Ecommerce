...
const Productpage = () => {
                            ...
                            <div className='grid gap-2'>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="bg-amber-300 hover:bg-amber-400 px-3 py-2 rounded-md"
                                    >
                                        Add
                                    </button>
                                </div>
                                ...
                                <div className="border p-4 rounded-md grid gap-4 mt-4">
                                    ...
                                    <div className="flex justify-end">
                                        <button
                                            ...
                                            className="bg-amber-300 hover:bg-amber-400 px-4 py-2 rounded-md"
                                        >
                                            Add Variant
                                        </button>
                                    </div>
    ...
    return (
        <section className="w-full">
            <div className='shadow-md px-6 py-3 flex items-center justify-between'>
                <h2 className='font-semibold lg:text-2xl text-neutral-800'>Upload Product</h2>
                <button 
                    type="button"
                    onClick={handleSubmit(onSubmit)}
                    disabled={isSubmitting}
                    className={`text-sm border-amber-400 bg-yellow-400 hover:bg-green-500 hover:text-black px-3 py-2 rounded ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                    {isSubmitting ? 'Publishing...' : 'Publish'}
                </button>
            </div>

            <div className="mt-2 grid gap-6 bg-white p-4 sm:p-6 rounded-lg shadow-md">
                {/* Tab Navigation */}
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-6">
                    ...
                    <div className="flex justify-end">
                        ...
                        type="submit"
                        disabled={isSubmitting}
                        className={`bg-amber-300 hover:bg-amber-400 rounded py-2 px-6 font-semibold ${
