...
const Login = () => {
  ...
  const [isContinueWithMobileLoading, setIsContinueWithMobileLoading] = useState(false);
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block outline-none w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 placeholder-gray-400 text-gray-900 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white shadow-sm sm:text-sm"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block outline-none w-full pl-10 pr-10 py-3 rounded-xl border border-gray-300 placeholder-gray-400 text-gray-900 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white shadow-sm sm:text-sm"
                    required
                  />
                  <button
                    type="button"
...
>
  ...
  <span className="text-sm text-gray-700">Remember me</span>
            ...
            <div className="mt-3">
              <button
                disabled={isContinueWithMobileLoading}
                onClick={() => {
                  setIsContinueWithMobileLoading(true);
                  setTimeout(() => {
                    navigate("/login/phone");
                  }, 400);
                }}
                className={`flex items-center justify-center w-full py-3 rounded-xl border transition-all duration-200 ${
                  isContinueWithMobileLoading
                    ? "bg-gray-100 border-gray-300 cursor-not-allowed opacity-70"
                    : "bg-white border-gray-300 hover:border-amber-300 hover:bg-amber-50"
                }`}
              >
