...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-100 via-white to-amber-200 p-6">
      ...
      >
        {/* Left Panel */}
        <div className="w-full p-6 flex flex-col justify-center bg-gradient-to-b from-amber-50 to-white">
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => handleSocialLogin('Google')}
              className="flex items-center justify-center py-2.5 rounded-lg bg-gray-200 hover:bg-gray-200 transition"
            >
              <FcGoogle className="text-red-500 mr-2" /> <span className="text-sm">Google</span>
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              ...
              className="flex items-center justify-center py-2.5 rounded-lg bg-gray-200 hover:bg-gray-200 transition"
            >
              <FaSquareFacebook  className="text-blue-600 mr-2" /> <span className="text-sm">Facebook</span>
            </motion.button>
          </div>
        ...
        {/* Decorative Right Side (no image) */}
        {/* <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-amber-400 via-amber-500 to-amber-700 items-center justify-center text-white flex-col p-10">
          <h2 className="text-4xl font-bold mb-3">Welcome!</h2>
          <p className="text-white/90 text-center max-w-sm text-sm">
            Sign up to explore the best deals, track your orders, and enjoy a seamless shopping experience.
          </p>
        </div> */}
      </motion.div>
    </div>
